...
ADMINS = list(map(int, os.environ.get('ADMINS', '7213276982').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://mdmatinashraf43:gymoW5DpuqoKf9xg@cluster0.s2falsa.mongodb.net/?retryWrites=true&w=majority')
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/Matiz_Tech")
        developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/Matiz_Tech_Owner")
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/TeraboxDownloaderActiveBot?start=verify_{token}')
            ...
            tutorial_button = InlineKeyboardButton("👉 How to Verify", url="https://t.me/Premium_Projects_Detail/5")
